...
public class SpecificationServiceImpl implements SpecificationService {
    ...
    public void add(Specification specification) {
        ...
        specificationMapper.insert(specification.getSpecification());//插入新增的规格

        //循环插入新增的规格参数
        for (TbSpecificationOption specificationOption : specification.getSpecificationOptionList()) {
            specificationOption.setSpecId(specification.getSpecification().getId());//设置specificationOption的Id
    ...
    public void update(Specification specification) {
        ...
        criteria.andSpecIdEqualTo(specification.getSpecification().getId());//指定 规格 ID 为条件
